...
inline const juce::Rectangle<int> autoGainToggleBounds { 200, 202, 72, 30 };
inline const juce::Rectangle<int> inputLedDotsBounds { 170, 290, 130, 18 };
inline const juce::Rectangle<int> inputDividerBounds { 48, 382, 365, 1 };
inline const juce::Rectangle<int> lowCutKnobBounds { 55, 420, 78, 78 };
inline const juce::Rectangle<int> cleanKnobBounds { 195, 420, 78, 78 };
inline const juce::Rectangle<int> deEssKnobBounds { 327, 420, 78, 78 };
